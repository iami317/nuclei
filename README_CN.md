...
自从[v2.5.2]((https://github.com/iami317/nuclei/releases/tag/v2.5.2))起，Nuclei就内置了自动下载和更新模板的功能。[**Nuclei模板**](https://github.com/projectdiscovery/nuclei-templates)仓库随时更新社区中可用的模板列表。
...
有关使用Nuclei作为Library/SDK的完整指南，请访问[godoc](https://pkg.go.dev/github.com/iami317/nuclei/v3/lib#section-readme)
...
感谢所有[社区贡献者提供的PR](https://github.com/iami317/nuclei/graphs/contributors)，并不断更新此项目:heart:
...
Nuclei使用[MIT许可证](https://github.com/iami317/nuclei/blob/main/LICENSE.md)
